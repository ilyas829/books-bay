...
/* ============ desktop view .end// ============ */
    ...
    <img src="img/books-bay-logo.png" width="80" height="80" class="d-inline-block align-top" alt="" loading="lazy">
  </a>
 ...
 echo'</div>
  ...
  if(isset($_GET['loginsuccess'])&& $_GET['loginsuccess']=="false"){
    $errmsg=$_GET['perror'];
    echo'<br><div class="alert alert-danger alert-dismissible fade show my-0" role="alert">
